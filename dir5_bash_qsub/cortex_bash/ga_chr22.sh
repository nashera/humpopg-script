...
height=25
width=150
process="/home/zhangxi/Document/LOG/cortex_chr22_process.txt"
...
do 
	...
	$ctx_binary --kmer_size $kmer --sample_id $ind --mem_height $height --mem_width $width --pe_list $pe1_list,$pe2_list --quality_score_threshold 10 --dump_binary $binname --remove_pcr_duplicates >$log 2>&1
	if [ -e "$process" ];then
