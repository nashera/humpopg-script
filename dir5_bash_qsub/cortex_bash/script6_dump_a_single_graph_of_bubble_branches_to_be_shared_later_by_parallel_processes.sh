...
#===============================================================================
#
#          FILE: script6_dump_a_single_graph_of_bubble_branches_to_be_shared_later_by_parallel_processes.sh
# 
#         USAGE: ./script6_dump_a_single_graph_of_bubble_branches_to_be_shared_later_by_parallel_processes.sh 
# 
#   DESCRIPTION: 
# 
#       OPTIONS: ---
...
ref_list="${ref_dir}/ref_binary_list"
ref="${ref_dir}/human_g1k_v37.proper_chroms.k31.ctx"
ref_col_list="${ref_dir}/ref_colour_list"
...
bubble_calls="${pool_chr_batch_dir}/$pop.chr$chr.batch$batch.k$kmer.q$quality.bubbles_thresh$T"
...
perl ${cortex_dir}/analyse_variants/make_branch_fasta.pl --callfile $bubble_calls --kmer 31 > $branches_log 2>&1 
...
suffix="${pop}_chr${chr}_batch${batch}_intersect_bubbles"
#ref_intersect_bin="${pool_chr_batch_dir}/$pop.chr$chr.batch$batch.k$kmer.q$quality.thresh$T.ref_intersect_with_bubbles.ctx"
ref_intersect_log="${pool_chr_batch_dir}/$pop.chr$chr.batch$batch.k$kmer.q$quality.thresh$T.ref_intersect_with_bubbles.ctx.log"
