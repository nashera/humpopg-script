...
BEGIN {
	unshift(@INC, "/home/zhangxi/perl5/lib/perl5");
	unshift(@INC, "/home/zhangxi/perl5/lib/perl5/x86_64-linux-thread-multi");
}
use strict;
use warnings;
use Getopt::Std;
...
use lib '/home/zhangxi/local/breakdancer/lib/breakdancer-max1.4.5';
use AlnParser;
